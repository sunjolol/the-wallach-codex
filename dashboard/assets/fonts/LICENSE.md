...
All fonts in this directory are distributed under the **SIL Open Font License Version 1.1** (OFL-1.1). The OFL is a free, open-source license that allows the fonts to be used, modified, and redistributed in any project, commercial or non-commercial, in perpetuity.
...
_(Reproduced verbatim from the canonical OFL text — this is the same license each font is distributed under.)_
...
_The OFL is recognized by the Open Source Initiative and the Free Software Foundation. Bundling these fonts with this dashboard is fully permitted under the license._
