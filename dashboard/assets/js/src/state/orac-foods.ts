/**
 * state/orac-foods.ts — read boundary for the ORAC tab's food league-table numbers
 * ═══════════════════════════════════════════════════════════════════════════
 *
 * Surfaces dashboard/assets/data/orac-foods-data.json to views/knowledge-orac.ts: every ORAC
 * score the §04–§06 food tables display, each parsed by the generator from a sealed
 * food_source claim's byte-faithful verbatim (§00.A — the scores have one home, this
