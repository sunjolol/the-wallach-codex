 ...
 * is left not understanding a medical/technical term.
 *
 ...
 * allowed only via `number_exempt`, which cites a sealed claim that literally contains it.
 *
...
export const GlossaryEntrySchema = z.object({
  ...
  // The app does not render it — it exists so the gate can prove the number
