 ...
 * ═══════════════════════════════════════════════════════════════════════════
 *
 * Shared by the Coverage field (the tile ring / chip dots) and the arrival veil (the goal
 * picker). It lives in core/ rather than in either view because BOTH need it and a
 * views→views import would couple two surfaces that should only share data — the same
 * reasoning that promoted the unit converter to core/units.ts when `boundaries` forbade a
 * state→state import.
 *
 ...
 * written twice.
 *
 * Ported from the signed-off demo (temporary/coverage-E-rail.html, RAW). Display values
 * only: no Wallach number lives here, and a goal is OUR curation, never his claim.
 * ═══════════════════════════════════════════════════════════════════════════
 */
