...
PYTHONUTF8=1 python tools/invariants.py  # the integrity board — 112 gates
...
`invariants.py` reports 112 gates. Green means **nothing drifted** — it does not mean anything is right.
