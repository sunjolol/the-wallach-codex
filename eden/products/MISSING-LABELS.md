...
- FitShake Banana Cream (USYG300012, ygy 10599) — RESOLVED 2026-07-07: NOT missing — label `banana-fitshake_pouch_0426_supp-facts_3.jpg` was on disk (my keyword search missed the 'banana-' prefix; matcher false-negative). Extracted as `fitshake-banana-cream` (name drops 'Youngevity').
