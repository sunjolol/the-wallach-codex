...
Empty until Phase β (first-book extraction). The spine of the whole corpus: every
index under `../indices/` is a pure derivation of these shards. Sharding keeps each
book's extraction + seal independent and the inbound books purely additive.
