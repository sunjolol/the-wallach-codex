...
Now holds six sealed books — `claims-dddl-3e-2011.json`, `claims-rare-earths.json`,
`claims-lets-play-doctor.json`, `claims-epigenetics.json`, `claims-immortality.json`,
and `claims-iaiyh.json` (the corpus grows as more books are mined). The spine of the
