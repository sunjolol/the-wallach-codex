...
clone. See the doctrine in `.claude/skills/round-close/SKILL.md` — "The covenant -- the
Creator's Log is sacred".
...
appends one line through `safe_write` (atomic write + byte-exact verify), and regenerates
