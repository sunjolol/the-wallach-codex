...
1. **Chunk-6 tweaks:** Luneth has "a few small changes" to the Essentials tab (unspecified — ask). Open decisions flagged to him: (a) tile names — keep canon common_name (Niacin B3 / Folate B9 / Vitamin D) or match the demo's "Vitamin B3 / B9 / D3"; (b) the demo mislabels the mid-dose trace group "Electrolytes & major minerals" (it holds boron/cobalt/…/zinc) — kept 1:1, likely a demo typo, keep or fix.
