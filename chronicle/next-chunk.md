...
- **chromium-demos-r1.html** — mineral / blue, one of the richest palettes. 5 concepts: A vicious-circle (sugar⟳chromium loop, RARE-000039+IMMORT-000091) · B **[KEPT as-is]** a-third-more-life +33.3% lifespan bars (RARE-000124) · C 1-in-100 grain field (99 ghosts, 1 glows; RARE-000074) · D **[KEPT as-is]** GTF gem emblem (DDDL-000200) · E dark provocation "a whole specialty wiped out" (DDDL-000046). **REVAMP LESSON:** Luneth called A/C/E "very boring/clinical" (a boxed loop, a bar chart, a stat dashboard) → the fix is a **visceral hero visual + motion** (glowing loop, one grain among 99, a bold dark provocation); B/D never needed it (each already had a hero — the +33.3% reversal, the Cr³⁺ gem). Also: I shipped the same overlap TWICE on A — fixed only captions, ignored the arrowhead icons he'd named; **when he says "text/icons," re-check BOTH and zoom before claiming fixed.** Target 620 mcg/day (Wallach-sourced, not a gap). Unbuilt angles: behavioral (sugar-crash→ADHD/depression/"Jekyll rages"/allergic shiners); serum-decline curio (1948→1985, numbers claim_text-only).
...
- **Every figure needs a HERO moment, not a diagram.** A boxed loop / bar chart / stat-tile dashboard reads "boring/clinical" and gets rejected;
  give it one visceral centrepiece + motion (see the chromium revamp). The benefit panel must land a visceral **"oh, so THIS is why"** — personal, topical ("Ever wonder why X? Here's the Y"). [[element-header-benefit-panel-needs-the-aha]], [[element-header-illustration-failure-modes]].
