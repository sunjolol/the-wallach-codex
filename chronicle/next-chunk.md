...
## ★ NEXT — Home shelves (Chunks 4-5), each ending in a Luneth visual STOP + round-close. ✓ Friendly display-name FOUNDATION + PROPAGATION + app-wide pluralization ALL DONE 2026-07-12 (commits dbbd11cf → 5950b361 → 640c5739) — the two bullets below are the completed record; the live work is Chunk 4.
