...
- Each mined claim routes to its correct home: **tier-1 operational** (conditions / symptoms / essentials) OR **search-only** (broader Wallach guidance), per the per-book policies in the corpus rules. **★ 2026-07-09: search is the LARGER home — capture EVERY search-worthy statement SYSTEMATICALLY per `.claude/rules/search-corpus.md`, not just the tier-1 veins; the old "search is secondary / case-by-case ask" framing is retired.**
