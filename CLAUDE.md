...
`PYTHONUTF8=1 python tools/invariants.py` — 109 gates. Green means **nothing drifted**. It does *not*
mean anything is right. Only the 25 gates anchored outside our own files (book bytes, physical
