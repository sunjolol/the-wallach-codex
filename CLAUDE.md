...
`PYTHONUTF8=1 python tools/invariants.py` — 113 gates. Green means **nothing drifted**. It does *not*
mean anything is right. Only the 27 gates anchored outside our own files (book bytes, physical
