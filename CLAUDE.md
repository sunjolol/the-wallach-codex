...
`PYTHONUTF8=1 python tools/invariants.py` — 110 gates. Green means **nothing drifted**. It does *not*
mean anything is right. Only the 26 gates anchored outside our own files (book bytes, physical
