...
Proof artifact (§00.B "codify, don't promise" / R7).
...
Run:  PYTHONUTF8=1 python tools/test_essentials_canon_matches_graphic.py
...
print("JPG and check it by eye — that is the honest limit of this chain (R7).")
sys.exit(0)
