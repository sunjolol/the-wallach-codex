// tools/render_probe_search_browse.js — Ask-Wallach BROWSE-BY-KIND flow + corner nav end-to-end.
//
// Usage: node tools/render_probe_search_browse.js   (exit 0 = PASS, non-zero = FAIL)
//
// Verifies the browse feature (2026-07-25): the five opening "kind of answer" cards (data-aw-family),
// dead until now, each open a BROWSE page listing that family's TOPICS as light cards (facet
