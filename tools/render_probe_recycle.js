// render_probe_recycle.js — P5 recycle bin: migration (no loss), delete→save-bin, restore
// slot (non-full + replace-when-full), restore item (origin + orphan→active), and the ring caps.
// Drives the real §31 window bridges. NEGATIVE CONTROLS baked into the asserts.
