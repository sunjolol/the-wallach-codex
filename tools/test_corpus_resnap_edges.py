#!/usr/bin/env python3
"""Negative test for corpus_resnap.relocate() edge preservation (§00.B "codify, don't promise" / R9).
...
so corpus_verify check #2, check #9 and the whole 81-gate board stayed green while 69 user-facing
...
The SPARING cases matter as much (R9 -- tighten, never over-fire): an edge run that the corrected
...
Run:  PYTHONUTF8=1 python tools/test_corpus_resnap_edges.py
