#!/usr/bin/env python3
"""Negative test for term_gloss_ratified_present (§00.B "codify, don't promise" / R7 · R9).
...
literal FROM-key match misses near-variants. Both would have landed on a green 76/76 board.
...
The sparing cases matter just as much (R9 -- tighten, never over-fire): the current sealed
text of both claims, and a claim naming neither genus, must stay silent.

Run:  PYTHONUTF8=1 python tools/test_term_gloss_ratified_present.py
...
CASES = [
    ...
    # --- must stay SILENT (R9: tighten, do not over-fire) --------------------------
