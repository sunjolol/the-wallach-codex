...
(async () => {
  ...
  const foods = await page.evaluate(() => {
    ...
    return {
      ...
      hasReadout: pageEl ? pageEl.querySelector('.kd-foods-readout .ds-pulse') !== null : false,
  ...
  const checks = [
    ...
    ['foods: rich landing renders (hero eyebrow+readout + pull-stat + 2 villi scans)', foods.shown === true && foods.headlineLen > 12 && foods.hasDeck === true && foods.hasEyebrow === true && foods.hasReadout === true && foods.hasStat === true && foods.villiArts === 2 && foods.villiFingers >= 14 && foods.villiDots === 12],
