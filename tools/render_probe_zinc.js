// tools/render_probe_zinc.js — the composed mechanism header (ZINC): hook + metal-fingers + coda.
//
// Usage: node tools/render_probe_zinc.js   (exit 0 = PASS, non-zero = FAIL)
//
...
//      zinc's node is smaller than copper's, so the glyph was cramped at 17.6 (Luneth 2026-07-29).
...
//      `.kd-ep-fam__figure { max-width: 560px }` is an ID selector, so a width override at lower
//      specificity silently loses and the whole figure renders at a fraction of its viewBox —
