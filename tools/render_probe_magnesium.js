// tools/render_probe_magnesium.js — the COMPOSED magnesium "cycle of life" header (element #5).
//
// Usage: node tools/render_probe_magnesium.js   (exit 0 = PASS, non-zero = FAIL)
//
