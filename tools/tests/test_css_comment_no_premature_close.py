#!/usr/bin/env python3
"""Negative control for check_css_comment_no_premature_close: a gate that only ever passes
proves nothing. This re-breaks CSS three ways and
...
Run: PYTHONUTF8=1 python tools/tests/test_css_comment_no_premature_close.py
