...
A gate that has never been seen to FAIL proves nothing. Each case below plants one defect and
asserts the detector fires, or plants a lookalike and asserts it does NOT.
