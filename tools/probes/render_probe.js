// tools/probes/render_probe.js — headless render check for the NEW dashboard.
//
// Usage: node tools/probes/render_probe.js
//
...
// the denominator holds) live in tools/probes/render_probe_coverage_add_remove.js.
//
// It is the build→test loop's eyes. Requires puppeteer (in node_modules).
//
// Selector contract: goal chips are .gchip, the reconciliation line is .ledger__recon, and
// the status vocabulary is covered/partial/present/gap. Any rename must land here in the
// same patch — a probe reading a dead class passes by finding nothing.
