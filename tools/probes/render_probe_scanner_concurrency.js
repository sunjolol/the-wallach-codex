// tools/probes/render_probe_scanner_concurrency.js — regression gate for the "Reading the
// label…" forever hang.
//
// Usage: node tools/probes/render_probe_scanner_concurrency.js   (exit 0 = PASS, non-zero = FAIL)
//
