// tools/probes/render_probe_search.js — Ask-Wallach (the centered green popup) end-to-end.
//
// Usage: node tools/probes/render_probe_search.js   (exit 0 = PASS, non-zero = FAIL)
//
// Verifies the CATCH-ALL search. Every exact match is RICH: an entity resolves across
