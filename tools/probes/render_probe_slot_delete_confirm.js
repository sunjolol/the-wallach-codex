// Slot delete takes a two-step confirm. Drives the REAL tile trash icon.
// Negative control: without the confirm, the first trash click deletes immediately (slots→1);
// this asserts slots STAY 2 after the first click (confirm shown, not deleted).
