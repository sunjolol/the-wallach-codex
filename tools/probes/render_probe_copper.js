// tools/probes/render_probe_copper.js — the COMPOSED mechanism header (copper).
//
// Usage: node tools/probes/render_probe_copper.js   (exit 0 = PASS, non-zero = FAIL)
//
...
//      (the mount prefix), so a width override at lower specificity silently loses and the whole figure renders at a fraction of its
