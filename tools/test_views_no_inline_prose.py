#!/usr/bin/env python3
"""Negative test for views_no_inline_prose (Phase H0 enforcement floor, R4 code-side).
...
Drives _views_no_inline_prose_impl with synthetic (relpath, text) inputs. Run:
    ...
    PYTHONUTF8=1 python tools/test_views_no_inline_prose.py
...
def main():
    results = []
    # baseline: the empty H0 clean surface is vacuously green
