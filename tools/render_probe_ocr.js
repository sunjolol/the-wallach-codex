// tools/render_probe_ocr.js — native OCR-parser check (Chunk 6c).
//
// Usage: node tools/render_probe_ocr.js   (exit 0 = PASS, non-zero = FAIL)
//
...
// the native verdict engine end-to-end. Seeds an empty regimen (HBSP base
// hidden) so the gap-fills are deterministic. Mirrors render_probe_scan.js.
